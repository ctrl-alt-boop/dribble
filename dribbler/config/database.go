...
var SavedConfigs map[string]*database.Target = map[string]*database.Target{
	"postgres_win": database.NewTarget("postgres_win", database.DBServer,
	...
	"postgres_local": database.NewTarget("postgres_local", database.DBServer,
		database.WithDriver("postgres"),
	...
	"mysql_local": database.NewTarget("mysql_local", database.DBServer,
