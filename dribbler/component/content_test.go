...
// func (m *mockLayout) AddCenterDefinition() {}

// // GetDefinition implements layout.Manager.
// func (m *mockLayout) GetDefinition() layout.RenderDefinition {
// 	return layout.NewDefinition([]layout.LayoutDefinition{})
// }
...
// 	assert.NotNil(t, ca.LayoutManager, "Layout should be initialized")
// 	assert.IsType(t, &layout.SimpleLayout{}, ca.LayoutManager, "Default layout should be SimpleLayout")
// }
