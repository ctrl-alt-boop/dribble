...
// var viewList = []func() *panel.Manager{
...
// func (t *DemoModel) Render() string {
// 	return "" // t.thing.View()
// }

// // View implements tea.Model.
// func (t *DemoModel) View() tea.View {
// 	return t.thing.View()
// }
...
// func createDemoDockContentAreaFull() *panel.Manager {
// 	top := data.TextItem("Top")
// 	bottom := data.TextItem("Bottom")
// 	left := data.TextItem("Left")
// 	right := data.TextItem("Right")
// 	center := data.TextItem("Center")
...
// 	contentArea := components.New("DockLayoutFull", dockLayout, top, bottom, left, right, center)
...
// func createDemoDockContentAreaFullRatios() *panel.Manager {
// 	top := data.TextItem("Top")
// 	bottom := data.TextItem("Bottom")
// 	left := data.TextItem("Left")
// 	right := data.TextItem("Right")
...
// func createDemoDockContentAreaNotFull() *panel.Manager {
// 	bottom := data.TextItem("Bottom")
// 	left := data.TextItem("Left")
// 	center := data.TextItem("Center")
...
// 	contentArea := components.New("DockLayoutNotFull", dockLayout, bottom, left, center)
...
// func createDemoDockContentAreaUnorderedModels() *panel.Manager {
// 	left := data.TextItem("Left")
// 	top := data.TextItem("Top")
// 	bottom := data.TextItem("Bottom")
// 	center := data.TextItem("Center")
...
// 	contentArea := components.New("DockLayoutNotFull", dockLayout, left, top, center, bottom, right)
...
// func createDemoPriorityContentAreaTop() *panel.Manager {
// 	contentList := createDemoList(4)

// 	contentArea := components.New("PrioritySplitTop",
...
// func createDemoPriorityContentAreaRight() *panel.Manager {
// 	contentList := createDemoList(4)

// 	contentArea := components.New("PrioritySplitRight", layout.NewPrioritySplitLayout(layout.Right), contentList...)
...
// func createDemoPriorityContentAreaBottom() *panel.Manager {
// 	contentList := createDemoList(4)

// 	contentArea := components.New("PrioritySplitBottom", layout.NewPrioritySplitLayout(layout.Bottom), contentList...)
// 	contentArea.SetStyle(lipgloss.NewStyle().Border(lipgloss.NormalBorder()))

// 	return contentArea
// }

// func createDemoPriorityContentAreaLeft() *panel.Manager {
// 	contentList := createDemoList(4)

// 	contentArea := components.New("PrioritySplitLeft", layout.NewPrioritySplitLayout(layout.Left), contentList...)
...
// func createDemoStackContentAreaHorizontal() *panel.Manager {
// 	contentList := createDemoList(3)

// 	contentArea := components.New("StackHorizontal", layout.NewStackLayout(layout.East), contentList...)
// 	contentArea.SetStyle(lipgloss.NewStyle().Border(lipgloss.NormalBorder()))

// 	return contentArea
// }

// func createDemoStackContentAreaVertical() *panel.Manager {
// 	contentList := createDemoList(3)

// 	contentArea := components.New("StackVertical", layout.NewStackLayout(layout.South), contentList...)
// 	contentArea.SetStyle(lipgloss.NewStyle().Border(lipgloss.NormalBorder()))

// 	return contentArea
// }

// func createDemoTabbedContentArea() *panel.Manager {
// 	contentList := createDemoList(4)

// 	contentArea := components.New("Tabbed", layout.NewTabbedLayout(layout.North), contentList...)
// 	contentArea.SetStyle(lipgloss.NewStyle().Border(lipgloss.NormalBorder()))

// 	return contentArea
// }

// func createDemo2x2GridContentArea() *panel.Manager {
// 	contentList := createDemoList(4)

// 	contentArea := components.New("2x2Grid",
...
// func createDemo2x3GridContentArea() *panel.Manager {
// 	contentList := createDemoList(6)

// 	contentArea := components.New("2x3Grid",
// 		layout.NewUniformGridLayout(
// 			3,
// 			layout.WithPanelBorder(lipgloss.ASCIIBorder()),
...
// func createDemo3x3GridContentArea() *panel.Manager {
// 	contentList := createDemoList(9)

// 	contentArea := components.New("3x3Grid",
// 		layout.NewUniformGridLayout(
// 			3,
// 			layout.WithPanelBorder(lipgloss.ASCIIBorder()),
// 			layout.WithStyle(lipgloss.NewStyle().BorderForeground(lipgloss.Color("205"))),
...
// func createDemoSimpleContentArea() *panel.Manager {
// 	contentArea := components.New("Simple", layout.NewSimpleLayout(), data.TextItem("Simple Layout"))
// 	contentArea.SetStyle(lipgloss.NewStyle().Border(lipgloss.NormalBorder()))

// 	return contentArea
// }

// func createDemoEmptyContentArea() *panel.Manager {
// 	contentArea := components.New("empty", layout.NewSimpleLayout())
// 	contentArea.SetStyle(lipgloss.NewStyle().Border(lipgloss.NormalBorder()))
// 	return contentArea
// }
...
// 		list = append(list, data.NewList([]data.Item{
