...
// // NewSQLite3DSN creates a new SQLite3DSN with the given options.
// func NewSQLite3DSN(opts ...DSNOption) *SQLite3DSN {
// 	dsn := &SQLite3DSN{}
...
// // WithPath sets the path for the DSN.
// func WithPath(path string) DSNOption {
